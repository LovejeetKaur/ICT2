...
$s = "select * from consultant where email='" . $email . "'";
...
if ($row = mysqli_fetch_array($result)) {
    ...
    <script>
        ...
        function editmodal(cid, name, duration, requirements, monthlycharges, benefits)
        {

            document.getElementById("einsid").value = cid;
        ...
        function editprofile(cid, name, email, phone, address, country, registeringcountry, password)
        {
            $("#myModal2").modal("show");
    ...
    <div class="main_body" style="min-height:600px;padding:50px;">
        <h1 class="mainhead">Consultant DashBoard</h1>
        <div class="row">
            <div class="col-sm-6">
                <div class="studentinfo">
                    <div class="row">
                        <div class="col-sm-4"><h4 class="showtexttitle">Consultant ID :</h4></div>
                        <div class="col-sm-8"><h4 class="showtext"><?php echo $row["cid"] ?></h4></div>
                    </div>
                    <div class="row">
                        <div class="col-sm-4"><h4 class="showtexttitle">Consultant Company Name :</h4></div>
                    ...
                    <div class="row">
                        <div class="col-sm-12" style="text-align:right;"><button class="btn btn-lg btn-primary"  onclick="editprofile('<?php echo $row["cid"] ?>', '<?php echo $row["name"] ?>', '<?php echo $row["email"] ?>', '<?php echo $row["phone"] ?>', '<?php echo $row["address"] ?>', '<?php echo $row["country"] ?>', '<?php echo $row["registeringcountry"] ?>', '<?php echo $row["password"] ?>')">Edit</button></div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                <h1 style="color: #000;margin: 20px;">Services Plans</h1>
                <div style="margin: 20px;background: #6b6b47;">
                    <div class="row" >

                        <?php
                        $s = "select * from serviceplans where cid='" . $_SESSION["cid"] . "'";
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <div class="col-sm-3" >
                                <div  style="text-align:center;box-shadow:1px 1px 1px #000;height:220px;width:200px;margin:50px auto;background: #ffffff">
                                    <img src="images/serviceplan.png" style="width:100px;height:100px;margin-top:5%;" />
                                    <h2 style="color:#000;margin-top:20px;font-size: 15px;"><?php echo $row["name"]; ?></h2>
                                    <button class="btn btn-small btn-primary" onclick="editmodal('<?php echo $row["sid"]; ?>', '<?php echo $row["name"]; ?>', '<?php echo $row["duration"]; ?>', '<?php echo $row["requirements"]; ?>', '<?php echo $row["monthlycharges"]; ?>', '<?php echo $row["benefits"]; ?>')">Edit</button>
                                </div>
                            </div>
                            <?php
                        }
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" style="color: #000;text-align: center;">ADD Service plan</h4>
            </div>
            <div class="modal-body">
                <form action="addserviceplan.php" method="POST" enctype="multipart/form-data" >
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" style="color: #000;text-align: center;">Edit Consultant Plan</h4>
            </div>
            <div class="modal-body">
                <form action="editserviceplan.php" method="POST" enctype="multipart/form-data" >
                    <div class="form-group">
                        <label for="name">Enter Plan Name</label>
                        <input type="text" class="form-control" id="einname" placeholder="Enter Plan Name" name="name" />
                    </div>
                    <input type="text" hidden="" id="einsid" placeholder="Enter Plan Name" name="sid" >
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="background: #ced4da">
                ...
                <form id="search_form" class="search_form" method="post" enctype="multipart/form-data" action="editconsultant.php" >
...
<div id="myModal3" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="background: #ced4da">
                <form id="search_form" action="editprofilepiccon.php" method="POST" enctype="multipart/form-data">
